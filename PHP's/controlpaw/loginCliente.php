...
// Query para verificar que la contraseña coincide y obtener el idCliente
$sql = "SELECT idCliente FROM cliente WHERE usuario = '$username' AND contraseña = '$hashedPassword'";
...
if ($result->num_rows > 0) {
    ...
    $response = $xml->addChild('idCliente', $idCliente);
} else {
